document.addEventListener("DOMContentLoaded", () => {
  ...
  function checkBoard() {
    for (let y = 0; y < winningsArray.length; y++) {
      const square1 = squares[winningsArray[y][0]];
      const square2 = squares[winningsArray[y][1]];
      const square3 = squares[winningsArray[y][2]];
      const square4 = squares[winningsArray[y][3]];
      if (
